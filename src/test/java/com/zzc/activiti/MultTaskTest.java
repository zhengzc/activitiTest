...
public class MultTaskTest extends BaseActTest {
	...
	public void start(){
		...
		this.runtimeService.startProcessInstanceByKey("multProcess",variables);
	}
...
//			ProcessCustomService.endProcess(task.getId(), variables);
			...
			this.runtimeService.messageEventReceived("refuseMessage", task.getExecutionId());
		} catch (Exception e) {
			e.printStackTrace();
		}
	}

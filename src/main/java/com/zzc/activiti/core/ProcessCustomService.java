...
import com.zzc.common.SpringAppContext;
...
public class  ProcessCustomService{  
	...
	private static ProcessEngine processEngine = SpringAppContext.getBean("processEngine");
	private static RepositoryService repositoryService = SpringAppContext.getBean("repositoryService");
	private static RuntimeService runtimeService = SpringAppContext.getBean("runtimeService");
	private static TaskService taskService = SpringAppContext.getBean("taskService");
	private static FormService formService = SpringAppContext.getBean("formService");
	private static HistoryService historyService = SpringAppContext.getBean("historyService");
     ...
     * @author zhengzhichao
     */  
    public static BpmnModel findBpmnModelByTaskId(  
            String taskId) throws Exception {  
        // 取得BPMN MODE
    	BpmnModel bpmnModel = repositoryService.getBpmnModel(findTaskById(taskId).getProcessDefinitionId());
